...
namespace Oterp_Back_end.Controllers
{
  ...
  public class CountriesController : ControllerBase
  {
    ...
    public CountriesController(OterpContext context)
    {
      _context = context;
    }
    ...
    public async Task<ActionResult<Countries>> PostCountries(Countries countries)
    {
      ...
      //return CreatedAtAction("GetCountries", new { id = countries.IDCountry }, countries);
      return CreatedAtAction(nameof(GetCountries), new { id = countries.IDCountry }, countries);
    }
    ...
    {
      return _context.CountriesList.Any(e => e.IDCountry == id);
    }
  }
}
